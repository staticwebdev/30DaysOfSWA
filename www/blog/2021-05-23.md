 ...
 * How can we create an architecture matrix to guide our end-to-end development experience?
 * **Exercise: Try to reproduce the architecture seen below!

![](../static/img/series/banner.png)


Today we explore the importance of a great development experience and how can you improve yours, building and deploying your static web applications, in Azure Static Web Apps!
...
I like structure, repeatability, patterns and conventions. I appreciate having a framework, an opinion many agree with so I'm on the same page with my team. And I like all of that, because it oftentimes leads to quick results and success.**
