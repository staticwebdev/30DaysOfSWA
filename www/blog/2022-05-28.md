...
To give you a brief idea, have a look to this 2 min video tutorial. It will show you how to get the internal ACS authentication token to connect to its infrastructure. Then, I’ll join an existing Teams meeting using a simple web page and the ACS JavaScript SDK:
