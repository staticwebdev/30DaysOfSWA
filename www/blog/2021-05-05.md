 ...
 * [**"routes"**](https://docs.microsoft.com/en-us/azure/static-web-apps/configuration#routes) - are an array of "route" objects that can each be associated with access rules ("allowedRoles"), actions ("redirect", "rewrite") - and request ("methods") and response ("headers","statusCode") properties.
 ...
 * [**"platform"**](https://docs.microsoft.com/en-us/azure/static-web-apps/configuration#platform) sets platform-specific configurations like _apiRuntime_ for API language runtime version.
 ...
 * [**Staging/Production:**](https://docs.microsoft.com/en-us/azure/static-web-apps/application-settings#configure-application-settings) You can define and configure these application settings in the [Azure Portal](https://portal.azure.com/) via the browser, or by using the [Azure CLI](https://docs.microsoft.com/en-us/cli/azure/) (see the [`az staticwebapp appsettings`](https://docs.microsoft.com/en-us/cli/azure/staticwebapp/appsettings?view=azure-cli-latest) documentation), to create and manage your application settings. These will be encrypted, and copied to staging and production environments.

Learn more about how you can configure application settings in [the documentation](https://docs.microsoft.com/en-us/azure/static-web-apps/application-settings#configure-application-settings).

## How-Tos: Watch It!

Want to see how application behavior configuration in action? Check out these two videos from the [Azure Static Web Apps: Tips & Tricks](https://docs.microsoft.com/en-us/shows/azure-tips-and-tricks-static-web-apps/) series.
