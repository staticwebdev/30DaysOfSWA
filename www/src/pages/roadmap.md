...
**Finalized:** _Welcome to the first week of your learning journey. Let's talk about some fundamental concepts for developing and deploying Static Web Apps. At the end of this week you should have built and deployed a basic SWA._

| Title / Author | What We'll Cover | Author(s) | Date |
|:---|:---|:---|:---|
| 1. **Introducing SWA** | - What is SWA? <br/> - How is it architected? <br/> - Where is it useful? <br/> **Visual:** 10 Things to Know About SWA <br/> **Exercise**: Explore SWA Examples | `Simona Cotin` <br/> `Nitya` |  May 2 |
| 2. **Building SWA**  |  - Getting Started (options) <br/> - Evaluating Plans (features) <br/> - Frameworks & SSGs (config) <br/> **Tutorial:** Build a Star Wars Crawler  <br/> **Exercise**: Try it yourself! | `Glaucia Llemos` <br/> `Nitya` | May 3|
| 3. **API-Enabling SWA**  | - Why go Serverless? <br/> - What is Azure Functions <br/> - Managed Functions <br/> - Bring Your Own <br/> **Tutorial:** [Stay Positive with SWAG!](https://github.com/sinedied/azure-swag/)  <br/> **Exercise**: Try it yourself!  | `Anthony Chu` <br/> `Nitya`| May 4 🌟 |
| 4. **Configuring SWA**  | - Configure SWA <br/> - Configure _app behavior_ <br/> - Configure _build process_ <br/> - Configure _env variables_ <br/> **Visual:** SWA Config Options <br/>  **Exercise:** [Explore example scenarios](https://docs.microsoft.com/en-us/azure/static-web-apps/configuration-overview#example-scenarios) | `Joseph Lin` <br/> `Nitya` | May 5  |
| 5. **Securing SWA** | - Authenticate users <br/> - Use custom providers <br/> - Manage user roles <br/> - Role-based authorization <br/>**Exercise:** [Assign Custom Roles](https://docs.microsoft.com/en-us/azure/static-web-apps/assign-roles-microsoft-graph)| `Mitali` <br/> `Nitya`  | May 6|
| 6. **Previewing SWA** | - Staging for deployment <br/> - Preview in Pull Requests <br/> - Preview in Branches <br/>  - Using custom domains <br/> **Exercise:** SWA Preview in branch  | `Michail`<br/> `Nitya` | May 7 |
| 7. **Deploying SWA** | - From GitLab <br/> - From BitBucket <br/> - With Azure DevOps <br/> - Using ARM Template <br/> **Tutorial:** [ARM Tools VS Code Extension](https://docs.microsoft.com/en-us/azure/azure-resource-manager/templates/quickstart-create-templates-use-visual-studio-code?tabs=CLI) <br/> **Exercise:** Try it!| `Reshmi`<br/> `Nitya`| May 8|

---

## Usage Examples 

**In Planning:** _Welcome to Week 2. So you know what SWA is but what web frameworks and libraries can you use it with? And what kinds of applications can you spin up quickly using this approach? Let's look at some examples_.
...
**In Planning:** _Welcome to Week 3 - let's talk about the developer experience in building and deploying modern web apps. We'll introduce you to a few tools that can simplify your develop-debug-deploy-test workflows. While some are SWA-specific, others are useful for modern web app dev in general._
